...
### 新增 Added
- **攒钱页**(第 5 个 Tab):储蓄目标 + 存款流水 + 年度储蓄预估
  - 目标模板一键创建:旅行基金、恋爱基金、应急备用金、买房首付、买车、数码心愿、婚礼、学习提升、健身、宠物、孝亲红包、心愿清单
  - 每个目标独立进度条、已存/目标金额、按"每月计划"推算预计达成年月;点击卡片展开存款流水(可删)
  - 记一笔存款:选目标、金额、日期、备注,持久化到本地
  - 年度预估双口径:按每月计划 × 12;按近 3 个月实际存款月均 × 12
  - 攒钱小知识卡:目标账户法、52 周阶梯存钱法(一年 13,780 元)、应急备用金 3–6 个月生活费
- 储蓄纯逻辑模块 `js/savings.js` 与 18 项单元测试(合计 74 项);导出/导入备份包含储蓄数据
